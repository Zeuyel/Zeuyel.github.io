...
title: "反常积分敛散性"
date: 2025-12-07
permalink: "/高数题源/反常积分敛散性/"
layout: post
graph: true
obsidian_source: "高数题源/反常积分敛散性.md"
---
...
已知积分 $\int_{0}^{+\infty} f(x)dx$ 收敛, 下列选项正确的是

A. 若 $f(x)$ 在 $[0,+\infty)$ 上有界, 则 $\lim_{x \to +\infty} f(x) = 0$.

B. 若 $f(x)$ 在 $[0,+\infty)$ 上连续, 则 $\lim_{x \to +\infty} f(x) = 0$.

C. 若 $f(x)$ 单调递减且恒正, 则 $\lim_{x \to +\infty} xf(x) > 0$.

D. 若 $f(x)$ 单调递减且恒正, 则 $\lim_{x \to +\infty} xf(x) =0$。
